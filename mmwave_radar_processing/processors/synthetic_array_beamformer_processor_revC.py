...
class SyntheticArrayBeamformerProcessor(_Processor):
    ...
    def __init__(
        ...
        Args:
            ...
            # cfar (CaCFAR): _description_  # Commented out CFAR parameter
        ...
        # self.cfar:CaCFAR_1D = cfar  # Commented out CFAR initialization
    ...
    def compute_2D_cfar_on_beamformed_resp(self)->np.ndarray:
        # Commented out the entire CFAR computation method
        # """
        ...
        # """
        pass  # Placeholder for the commented-out CFAR logic

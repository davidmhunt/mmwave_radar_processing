...
class GroundPointCloudGenerator(RangeDopplerGroundDetector):
    """
    Gerenates a 3D point cloud of the ground from raw ADC data using a standard radar signal processing pipeline.
    
    Pipeline steps:
    1. Range-Doppler Processing
    2. Ground Detection (via altimeter)
    2. CFAR Detection
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            vel_cfar_type=vel_cfar_type,
            vel_cfar_params=vel_cfar_params,
            altimeter_params=altimeter_params,
            **kwargs
        )
        
        self.logger.info(f"GroundPointCloudGenerator initialized")
